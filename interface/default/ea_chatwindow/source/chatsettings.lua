...
function ChatSettings.SetupChannels()
    ...
    ChatSettings.Channels[ SystemData.ChatLogFilters.CHANNEL_9 ]              = ChatChannel( GetChatString(StringTables.Chat.CHAT_CHANNEL_NAME_CHANNEL_9),                SystemData.ChatLogFilters.CHANNEL_9,                "Chat",     true,                   ChannelColor(235, 235, 235),    SystemData.ChatLogFilters.CHANNEL_9,        GetChatString(StringTables.Chat.CHAT_CHANNEL_CMD_CHANNEL_9) )
